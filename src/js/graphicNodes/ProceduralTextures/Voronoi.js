...
export default class VoronoiNode extends RenderNode{
    constructor(mainRender) {
        ...
        this.shader = `${SHADERS.BASE_SHADER}${SHADERS.BASE_MAIN_HEADER}${SHADERS.VORONOI_MAIN}${SHADERS.BASE_MAIN_FOOTER}`;
        ...
        const fgColorParam = {
            ...
            defaultVal: this.material.uniforms.u_user_fgColor.value,
        };
        ...
        const bgColorParam = {
            ...
            paramHelpersType: 'shaderParam',
            needsFrameUpdate: false,
            defaultVal: this.material.uniforms.u_user_bgColor.value,
        };
