...
export const getStartDragDataAtom = (ID, type, atomPosition, outerRing) => {
    ...
    console.log('conn data: ', ret.connectionData);
...
export const getDraggingAtomDragData = (object, draggingAtomInstance) => {
    ...
    */
    ...
    // console.log('dragging: ', connectionDataKeys);
...
export const getStartDragDataElectron = (ID, atomPosition, object) => {
    ...
    ret.startPosition = new THREE.Vector2(object.position.x, object.position.y);

    console.log('start: ', ret.startPosition);
...
export const getDraggingElectronDragData = (dragObj, visibleRings, dragData) => {
    const ret = {};
    const { centerPoint, startPosition } = dragData;
...
export const onElectronDragEnd = (ringToReleaseOn, electronObj, visibleRings, position, object, dragData) => {
    const { startPosition } = dragData;
    const dragObjVector = new THREE.Vector2(object.position.x, object.position.y);
    const dragDistance = startPosition.distanceTo(dragObjVector);
